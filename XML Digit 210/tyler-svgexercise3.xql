...
/*# sourceURL=ace/css/ace_editor.css */</style>
        ...
        <link rel="stylesheet" type="text/css" href="./tyler-svgexercise3_files/jquery-ui-1.10.3.custom.min.css">
        <link rel="stylesheet" type="text/css" href="./tyler-svgexercise3_files/jquery.pnotify.default.css">
        <link rel="stylesheet" href="./tyler-svgexercise3_files/font-awesome.min.css">
        <link rel="stylesheet" href="./tyler-svgexercise3_files/ag-grid.css">
        <link rel="stylesheet" href="./tyler-svgexercise3_files/ag-theme-alpine.css">
        <link rel="stylesheet" type="text/css" href="./tyler-svgexercise3_files/eXide.css">
        <script type="text/javascript" src="./tyler-svgexercise3_files/modernizr.custom.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/jquery-1.9.1.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/jquery-ui-1.10.3.custom.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/jquery.pnotify.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/jquery.plugins.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/d3.v3.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/less.min.js.download"></script>
        <script src="./tyler-svgexercise3_files/ace.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/theme-eclipse.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-javascript.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-xml.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-c_cpp.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-html.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-css.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-less.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-snippets.js.download" type="text/javascript"></script>
        <script src="./tyler-svgexercise3_files/mode-json.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/mode-markdown.js.download" type="text/javascript" charset="utf-8"></script>
        <script src="./tyler-svgexercise3_files/ext-language_tools.js.download" type="text/javascript" charset="utf-8"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/xqlint.min.js.download"></script>
        <script type="text/javascript" src="./tyler-svgexercise3_files/eXide.min.js.download"></script>
    ...
    <script src="./tyler-svgexercise3_files/theme-github.js.download"></script></head>
    <body data-new-gr-c-s-loaded="14.1010.0" data-new-gr-c-s-check-loaded="14.1009.0" data-gr-ext-installed="">
        <div id="splash" style="display: none;">
            <div>
                <img src="./tyler-svgexercise3_files/logo.png">
                <p>
            ...
            <div class="editor-header">
                <div class="menu">
                    <ul>
                        ...
                        <li>
                            <a href="http://exist.newtfire.org/exist/apps/eXide/index.html#" class="">Edit</a>
                            <ul style="display: none;">
                                <li>
                        ...
                        <li id="menu-xquery" style="display: list-item;">
                ...
                <span id="toolbar">
                    <div class="options">
                        ...
                        <a id="toggle-fullscreen" href="http://exist.newtfire.org/exist/apps/eXide/index.html#" title="Toggle Fullscreen Mode">
                            <img src="./tyler-svgexercise3_files/fullscreen.png">
                        </a>
                    </div>
                    <span class="toolbar-buttons ui-buttonset">
                        ...
                        <button id="eval" title="Evaluate current query inside eXide" class="ui-button ui-widget ui-state-default ui-button-text-icon-primary" role="button" aria-disabled="false"><span class="ui-button-icon-primary ui-icon fa fa-cogs"></span><span class="ui-button-text">Eval</span></button>
                     ...
                     <div id="outline-container" class="panel-west" style="width: 200px; min-width: 200px;">
                            ...
                            <div id="outline-body" style="position: relative;" class="ace-github">
                                <div class="ace_scroller">
                                    <ul id="outline" style="font-family: &quot;Ubuntu Mono&quot;, Monaco, Menlo, &quot;Droid Sans Mono&quot;, &quot;Courier New&quot;, monospace;"><li class="t_variable public"><a href="http://exist.newtfire.org/exist/apps/eXide/index.html#" style="opacity: 1;">$ThisFileContent</a></li><li class="t_variable public"><a href="http://exist.newtfire.org/exist/apps/eXide/index.html#" style="opacity: 1;">$xSpacer</a></li><li class="t_variable public"><a href="http://exist.newtfire.org/exist/apps/eXide/index.html#" style="opacity: 1;">$ySpacer</a></li></ul>
                                </div>
                            </div>
                        ...
                        <div class="layout-vertical">
                            <div class="main">
                                <div id="tabs-container" style="overflow: hidden;">
                                    <ul id="tabs">
                                        <li><a class="tab ui-draggable ui-droppable active" id="t5" title="/db//tec5271/svgexercise3" style="position: relative;">svgexercise3*</a></li><li class="drop-placeholder">
                                ...
                                <div class="content ace_editor ace_hidpi ace-github" id="editor" style="font-family: &quot;Ubuntu Mono&quot;, Monaco, Menlo, &quot;Droid Sans Mono&quot;, &quot;Courier New&quot;, monospace; font-size: 14px;" draggable="false"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; transform: translate(96px, 96px);"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 50px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, 0px); width: 50px;"><div class="ace_gutter-cell " style="height: 16px; top: 0px;">1<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 16px;">2<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 32px;">3<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 48px;">4<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 64px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 16px; top: 80px;">6<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 96px;">7<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 112px;">8<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 128px;">9<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 144px;">10<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 160px;">11<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 176px;">12<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 192px;">13<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 208px;">14<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 224px;">15<span class="ace_fold-widget ace_start ace_open" style="height: 16px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 240px;">16<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 256px;">17<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 272px;">18<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 288px;">19<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 304px;">20<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 320px;">21<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div></div></div><div class="ace_scroller" style="line-height: 16px; left: 49.8047px; right: 17px; bottom: 0px;"><div class="ace_content" style="transform: translate(0px, 0px); width: 1033px; height: 315px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 16px; top: 80px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, 0px);"><div class="ace_line" style="height: 16px; top: 0px;"><span class="ace_keyword">xquery</span> <span class="ace_keyword">version</span> <span class="ace_string">"</span><span class="ace_string">3.1</span><span class="ace_string">"</span>;</div><div class="ace_line" style="height: 16px; top: 16px;"><span class="ace_keyword">declare</span> <span class="ace_keyword">variable</span> <span class="ace_variable">$ySpacer</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_constant">10</span>;</div><div class="ace_line" style="height: 16px; top: 32px;"><span class="ace_keyword">declare</span> <span class="ace_keyword">variable</span> <span class="ace_variable">$xSpacer</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_constant">29.5</span>;</div><div class="ace_line" style="height: 16px; top: 48px;"><span class="ace_keyword">declare</span> <span class="ace_keyword">variable</span> <span class="ace_variable">$ThisFileContent</span> <span class="ace_keyword ace_operator">:=</span></div><div class="ace_line" style="height: 16px; top: 64px;"></div><div class="ace_line" style="height: 16px; top: 80px;"><span class="ace_meta ace_tag">&lt;svg</span> <span class="ace_entity ace_other ace_attribute-name">width</span>=<span class="ace_string">"</span><span class="ace_string">1000</span><span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">height</span>=<span class="ace_string">"</span><span class="ace_string">1000</span><span class="ace_string">"</span><span class="ace_meta ace_tag">&gt;</span></div><div class="ace_line" style="height: 16px; top: 96px;"><span class="ace_meta ace_tag">&lt;g</span> <span class="ace_entity ace_other ace_attribute-name">transform</span>=<span class="ace_string">"</span><span class="ace_string">translate(30, 600)</span><span class="ace_string">"</span><span class="ace_meta ace_tag">&gt;</span></div><div class="ace_line" style="height: 16px; top: 112px;"></div><div class="ace_line" style="height: 16px; top: 128px;">{</div><div class="ace_line" style="height: 16px; top: 144px;"><span class="ace_keyword">let</span> <span class="ace_variable">$ac</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_support ace_function">doc</span>(<span class="ace_string">'</span><span class="ace_string">/db/assassinsCreed/assassinscreedodyssey.xml</span><span class="ace_string">'</span>)/<span class="ace_support ace_function">script</span></div><div class="ace_line" style="height: 16px; top: 160px;"><span class="ace_keyword">let</span> <span class="ace_variable">$sections</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_variable">$ac</span>/*</div><div class="ace_line" style="height: 16px; top: 176px;"><span class="ace_keyword">for</span> <span class="ace_variable">$s</span> <span class="ace_keyword">at</span> <span class="ace_variable">$pos</span> <span class="ace_keyword">in</span> <span class="ace_variable">$sections</span></div><div class="ace_line" style="height: 16px; top: 192px;"><span class="ace_keyword">let</span> <span class="ace_variable">$spks</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_variable">$s</span>//<span class="ace_support ace_function">speaker</span> ! <span class="ace_support ace_function">normalize-space</span>() <span class="ace_keyword ace_operator">=</span><span class="ace_keyword ace_operator">&gt;</span> <span class="ace_support ace_function">distinct-values</span>() <span class="ace_keyword ace_operator">=</span><span class="ace_keyword ace_operator">&gt;</span> <span class="ace_keyword">count</span>()</div><div class="ace_line" style="height: 16px; top: 208px;"><span class="ace_keyword">let</span> <span class="ace_variable">$actions</span> <span class="ace_keyword ace_operator">:=</span> <span class="ace_variable">$s</span>//<span class="ace_support ace_function">action</span> <span class="ace_keyword ace_operator">=</span><span class="ace_keyword ace_operator">&gt;</span> <span class="ace_keyword">count</span>()</div><div class="ace_line" style="height: 16px; top: 224px;"><span class="ace_keyword">return</span></div><div class="ace_line" style="height: 16px; top: 240px;">    <span class="ace_comment">(:</span><span class="ace_comment"> concat($spks, ": ", $actions )</span><span class="ace_comment">:)</span></div><div class="ace_line" style="height: 16px; top: 256px;"><span class="ace_meta ace_tag">&lt;g</span><span class="ace_meta ace_tag">&gt;</span></div><div class="ace_line" style="height: 16px; top: 272px;"><span class="ace_meta ace_tag">&lt;line</span> <span class="ace_entity ace_other ace_attribute-name">x1</span>=<span class="ace_string">"</span>{<span class="ace_variable">$pos</span> * <span class="ace_variable">$xSpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">x2</span>=<span class="ace_string">"</span>{<span class="ace_variable">$pos</span> * <span class="ace_variable">$xSpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">y1</span>=<span class="ace_string">"</span><span class="ace_string">0</span><span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">y2</span>=<span class="ace_string">"</span><span class="ace_string">-</span>{<span class="ace_variable">$actions</span> * <span class="ace_variable">$ySpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">stroke</span>=<span class="ace_string">"</span><span class="ace_string">orange</span><span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">stroke-width</span>=<span class="ace_string">"</span><span class="ace_string">15</span><span class="ace_string">"</span><span class="ace_meta ace_tag ace_r">/&gt;</span></div><div class="ace_line" style="height: 16px; top: 288px;"><span class="ace_meta ace_tag">&lt;line</span> <span class="ace_entity ace_other ace_attribute-name">x1</span>=<span class="ace_string">"</span>{<span class="ace_variable">$pos</span> * <span class="ace_variable">$xSpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">x2</span>=<span class="ace_string">"</span>{<span class="ace_variable">$pos</span> * <span class="ace_variable">$xSpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">y1</span>=<span class="ace_string">"</span><span class="ace_string">0</span><span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">y2</span>=<span class="ace_string">"</span><span class="ace_string">-</span>{<span class="ace_variable">$spks</span> * <span class="ace_variable">$ySpacer</span>}<span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">stroke</span>=<span class="ace_string">"</span><span class="ace_string">blue</span><span class="ace_string">"</span> <span class="ace_entity ace_other ace_attribute-name">stroke-width</span>=<span class="ace_string">"</span><span class="ace_string">5</span><span class="ace_string">"</span><span class="ace_meta ace_tag ace_r">/&gt;</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; transform: translate(46px, 80px); width: 8px; height: 16px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 22px; bottom: 17px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 1088px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="height: 22px; left: 49.8047px; right: 17px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 1033px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div><div class="ace_tooltip" style="display: none; left: 247px; top: 209px;">$spks: unused variable.</div></div>
                                <div id="status-bar">
                                    <span id="status">
                                        <a href="http://exist.newtfire.org/exist/rest/db/tec5271/svgexercise3" target="blank" title="Run in new tab" style="visibility: visible;">
                                            <span class="fa fa-share"></span>
                                        </a>
                                        <span class="path">/db//tec5271/svgexercise3</span>
                                    </span>
                                    <a href="http://exist.newtfire.org/db//tec5271/svgexercise3#63" id="error-status"></a>
                                </div>
                                <div id="ext-status-bar" style="display: none;">error found while executing expression: org.exist.xquery.XPathException: err:XPST0003 expecting EOF, found 'let' [at line 68, column 1]
</div>
                            </div>
                            <div class="panel-south results-container" style="height: 147px;">
                                <div class="resize-handle">
                            ...
                            <div class="navbar" style="display: block;">
                                    ...
                                    <img class="layout-switcher" src="./tyler-svgexercise3_files/layouts_split.png" title="Switch results panel location between bottom and right">
                                ...
                                </div><div id="results-body" style="font-family: &quot;Ubuntu Mono&quot;, Monaco, Menlo, &quot;Droid Sans Mono&quot;, &quot;Courier New&quot;, monospace; display: block; height: 119px;" class="ace-github">
                                    <div class="ace_marker-layer">
                                        <div class="results"></div>
                                    </div>
                                    <iframe id="results-iframe" style="width: 1075px; height: 119px; display: block;" src="JavaScript:&#39;&#39;" src="./tyler-svgexercise3_files/saved_resource.html"></iframe>
                                </div></div>
                        </div>
        ...
        <!--AG-HEADER-ROOT--><div class="ag-header ag-focus-managed ag-pivot-off" role="presentation" unselectable="on" ref="gridHeader" style="height: 65px; min-height: 65px;"><div class="ag-pinned-left-header ag-hidden" role="presentation" style="width: 0px; max-width: 0px; min-width: 0px;"><div class="ag-header-row ag-header-row-column" role="row" aria-rowindex="1" style="top: 0px; height: 32px; width: 0px;"></div><div class="ag-header-row ag-header-row-column-filter" role="row" aria-rowindex="2" style="top: 32px; height: 32px; width: 0px;"></div></div><div class="ag-header-viewport" role="presentation">
            <div class="ag-header-container" ref="eCenterContainer" role="rowgroup" style="width: 621px; transform: translateX(0px);"><div class="ag-header-row ag-header-row-column" role="row" aria-rowindex="1" style="top: 0px; height: 32px; width: 621px;"><div class="ag-header-cell ag-focus-managed" role="columnheader" unselectable="on" tabindex="-1" col-id="name" aria-colindex="1" style="width: 131px; left: 0px;">
        ...
        </div></div><div class="ag-header-cell ag-focus-managed" role="columnheader" unselectable="on" tabindex="-1" col-id="permissions" aria-colindex="2" style="width: 110px; left: 131px;">
            <div ref="eResize" class="ag-header-cell-resize" role="presentation"></div><div role="presentation" class="ag-labeled ag-label-align-right ag-checkbox ag-input-field ag-header-select-all ag-hidden">
                <div ref="eLabel" class="ag-input-field-label ag-label ag-hidden ag-checkbox-label" role="presentation"></div>
                <div ref="eWrapper" class="ag-wrapper ag-input-wrapper ag-checkbox-input-wrapper" role="presentation">
        ...
        </div></div><div class="ag-header-cell ag-focus-managed" role="columnheader" unselectable="on" tabindex="-1" col-id="owner" aria-colindex="3" style="width: 90px; left: 241px;">
            <div ref="eResize" class="ag-header-cell-resize" role="presentation"></div><div role="presentation" class="ag-labeled ag-label-align-right ag-checkbox ag-input-field ag-header-select-all ag-hidden">
                <div ref="eLabel" class="ag-input-field-label ag-label ag-hidden ag-checkbox-label" role="presentation"></div>
                <div ref="eWrapper" class="ag-wrapper ag-input-wrapper ag-checkbox-input-wrapper" role="presentation">
        ...
        </div></div><div class="ag-header-cell ag-focus-managed" role="columnheader" unselectable="on" tabindex="-1" col-id="group" aria-colindex="4" style="width: 90px; left: 331px;">
            <div ref="eResize" class="ag-header-cell-resize" role="presentation"></div><div role="presentation" class="ag-labeled ag-label-align-right ag-checkbox ag-input-field ag-header-select-all ag-hidden">
                <div ref="eLabel" class="ag-input-field-label ag-label ag-hidden ag-checkbox-label" role="presentation"></div>
                <div ref="eWrapper" class="ag-wrapper ag-input-wrapper ag-checkbox-input-wrapper" role="presentation">
        ...
        </div></div><div class="ag-header-cell ag-focus-managed" role="columnheader" unselectable="on" tabindex="-1" col-id="lastMod" aria-colindex="5" style="width: 200px; left: 421px;">
            <div ref="eResize" class="ag-header-cell-resize" role="presentation"></div><div role="presentation" class="ag-labeled ag-label-align-right ag-checkbox ag-input-field ag-header-select-all ag-hidden">
                <div ref="eLabel" class="ag-input-field-label ag-label ag-hidden ag-checkbox-label" role="presentation"></div>
                <div ref="eWrapper" class="ag-wrapper ag-input-wrapper ag-checkbox-input-wrapper" role="presentation">
        ...
        </div></div></div><div class="ag-header-row ag-header-row-column-filter" role="row" aria-rowindex="2" style="top: 32px; height: 32px; width: 621px;"><div class="ag-header-cell ag-floating-filter ag-focus-managed" role="gridcell" tabindex="-1" aria-colindex="1" style="width: 131px; left: 0px;">
        ...
        </div><div class="ag-header-cell ag-floating-filter ag-focus-managed" role="gridcell" tabindex="-1" aria-colindex="2" style="width: 110px; left: 131px;">
            <div ref="eFloatingFilterBody" role="presentation"></div>
            <div class="ag-floating-filter-button ag-hidden" ref="eButtonWrapper" role="presentation">
                <button type="button" aria-label="Open Filter Menu" class="ag-floating-filter-button-button" ref="eButtonShowMainFilter" tabindex="-1"></button>
            </div>
        </div><div class="ag-header-cell ag-floating-filter ag-focus-managed" role="gridcell" tabindex="-1" aria-colindex="3" style="width: 90px; left: 241px;">
            <div ref="eFloatingFilterBody" role="presentation"></div>
            <div class="ag-floating-filter-button ag-hidden" ref="eButtonWrapper" role="presentation">
                <button type="button" aria-label="Open Filter Menu" class="ag-floating-filter-button-button" ref="eButtonShowMainFilter" tabindex="-1"></button>
            </div>
        </div><div class="ag-header-cell ag-floating-filter ag-focus-managed" role="gridcell" tabindex="-1" aria-colindex="4" style="width: 90px; left: 331px;">
            <div ref="eFloatingFilterBody" role="presentation"></div>
            <div class="ag-floating-filter-button ag-hidden" ref="eButtonWrapper" role="presentation">
                <button type="button" aria-label="Open Filter Menu" class="ag-floating-filter-button-button" ref="eButtonShowMainFilter" tabindex="-1"></button>
            </div>
        </div><div class="ag-header-cell ag-floating-filter ag-focus-managed" role="gridcell" tabindex="-1" aria-colindex="5" style="width: 200px; left: 421px;">
            <div ref="eFloatingFilterBody" role="presentation"></div>
            <div class="ag-floating-filter-button ag-hidden" ref="eButtonWrapper" role="presentation">
                <button type="button" aria-label="Open Filter Menu" class="ag-floating-filter-button-button" ref="eButtonShowMainFilter" tabindex="-1"></button>
            </div>
        </div></div></div>
        </div><div class="ag-pinned-right-header ag-hidden" role="presentation" style="width: 17px; max-width: 17px; min-width: 17px;"><div class="ag-header-row ag-header-row-column" role="row" aria-rowindex="1" style="top: 0px; height: 32px; width: 0px;"></div><div class="ag-header-row ag-header-row-column-filter" role="row" aria-rowindex="2" style="top: 32px; height: 32px; width: 0px;"></div></div></div>
        <div class="ag-floating-top" ref="eTop" role="presentation" unselectable="on" style="min-height: 0px; height: 0px; display: none; overflow-y: scroll;">
            ...
            <!--AG-ROW-CONTAINER--><div class="ag-floating-top-viewport" ref="topCenterContainer" role="presentation" unselectable="on" name="topCenter">
                <div class="ag-floating-top-container" ref="eContainer" role="presentation" unselectable="on" style="width: 621px; transform: translateX(0px);"></div>
            </div>
        ...
        <div class="ag-body-viewport ag-layout-normal ag-row-no-animation" ref="eBodyViewport" role="presentation">
            <!--AG-ROW-CONTAINER--><div class="ag-pinned-left-cols-container ag-hidden" ref="leftContainer" role="presentation" unselectable="on" name="left" style="height: 256px;"><div comp-id="7649" style="transform: translateY(0px); height: 32px;" row-index="0" aria-rowindex="3" class="ag-row-even ag-row-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-first ag-after-created" role="row" row-id="0"></div><div comp-id="7650" style="transform: translateY(32px); height: 32px;" row-index="1" aria-rowindex="4" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="1"></div><div comp-id="7651" style="transform: translateY(64px); height: 32px;" row-index="2" aria-rowindex="5" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="2"></div><div comp-id="7652" style="transform: translateY(96px); height: 32px;" row-index="3" aria-rowindex="6" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="3"></div><div comp-id="7653" style="transform: translateY(128px); height: 32px;" row-index="4" aria-rowindex="7" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="4"></div><div comp-id="7654" style="transform: translateY(160px); height: 32px;" row-index="5" aria-rowindex="8" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="5"></div><div comp-id="7655" style="transform: translateY(192px); height: 32px;" row-index="6" aria-rowindex="9" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="6"></div><div comp-id="7656" style="transform: translateY(224px); height: 32px;" row-index="7" aria-rowindex="10" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-last ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="7"></div></div>
            <!--AG-ROW-CONTAINER--><div class="ag-center-cols-clipper" ref="centerContainer" role="presentation" unselectable="on" name="center" style="height: 256px;">
                <div class="ag-center-cols-viewport" ref="eViewport" role="presentation" style="height: 100%;">
                    <div class="ag-center-cols-container" ref="eContainer" role="rowgroup" unselectable="on" style="width: 621px; height: 256px;"><div comp-id="7657" style="transform: translateY(0px); height: 32px;" row-index="0" aria-rowindex="3" class="ag-row-even ag-row-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-first ag-after-created" role="row" row-id="0"><div comp-id="7666" class="ag-cell-focus ag-cell ag-cell-not-inline-editing ag-cell-normal-height collection ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">..</div><div comp-id="7667" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;"></div><div comp-id="7668" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;"></div><div comp-id="7669" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;"></div><div comp-id="7670" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;"></div></div><div comp-id="7658" style="transform: translateY(32px); height: 32px;" row-index="1" aria-rowindex="4" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="1"><div comp-id="7672" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">drb-sample-query.xql</div><div comp-id="7673" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rwxr-xr-x</div><div comp-id="7674" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">admin</div><div comp-id="7675" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">dba</div><div comp-id="7676" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">03/16/2022 17:40:09</div></div><div comp-id="7659" style="transform: translateY(64px); height: 32px;" row-index="2" aria-rowindex="5" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="2"><div comp-id="7678" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">drbquery.xql</div><div comp-id="7679" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rwxr-xr-x</div><div comp-id="7680" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">admin</div><div comp-id="7681" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">dba</div><div comp-id="7682" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">03/16/2022 17:40:49</div></div><div comp-id="7660" style="transform: translateY(96px); height: 32px;" row-index="3" aria-rowindex="6" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="3"><div comp-id="7684" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">svgexercise2</div><div comp-id="7685" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rwxr-xr-x</div><div comp-id="7686" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">tec5271</div><div comp-id="7687" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">tec5271</div><div comp-id="7688" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">Today 13:20:17</div></div><div comp-id="7661" style="transform: translateY(128px); height: 32px;" row-index="4" aria-rowindex="7" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="4"><div comp-id="7690" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">svgexercise3</div><div comp-id="7691" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rwxr-xr-x</div><div comp-id="7692" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">tec5271</div><div comp-id="7693" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">tec5271</div><div comp-id="7694" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">Today 13:20:54</div></div><div comp-id="7662" style="transform: translateY(160px); height: 32px;" row-index="5" aria-rowindex="8" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="5"><div comp-id="7696" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">xpathexercise2.md</div><div comp-id="7697" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rw-r--r--</div><div comp-id="7698" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">tec5271</div><div comp-id="7699" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">tec5271</div><div comp-id="7700" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">03/16/2022 17:45:53</div></div><div comp-id="7663" style="transform: translateY(192px); height: 32px;" row-index="6" aria-rowindex="9" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="6"><div comp-id="7702" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">XPathexercise3.md</div><div comp-id="7703" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rw-r--r--</div><div comp-id="7704" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">tec5271</div><div comp-id="7705" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">tec5271</div><div comp-id="7706" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">03/16/2022 17:45:54</div></div><div comp-id="7664" style="transform: translateY(224px); height: 32px;" row-index="7" aria-rowindex="10" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-last ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="7"><div comp-id="7708" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="1" col-id="name" unselectable="on" style="left: 0px; width: 131px;">xpathgettingstarted.md</div><div comp-id="7709" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="2" col-id="permissions" unselectable="on" style="left: 131px; width: 110px;">-rw-r--r--</div><div comp-id="7710" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="3" col-id="owner" unselectable="on" style="left: 241px; width: 90px;">tec5271</div><div comp-id="7711" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="4" col-id="group" unselectable="on" style="left: 331px; width: 90px;">tec5271</div><div comp-id="7712" class="ag-cell ag-cell-not-inline-editing ag-cell-normal-height ag-cell-value" tabindex="-1" role="gridcell" aria-colindex="5" col-id="lastMod" unselectable="on" style="left: 421px; width: 200px;">03/16/2022 17:45:54</div></div></div>
                </div>
            </div>
            <!--AG-ROW-CONTAINER--><div class="ag-pinned-right-cols-container ag-hidden" ref="rightContainer" role="presentation" unselectable="on" name="right" style="height: 256px;"><div comp-id="7665" style="transform: translateY(0px); height: 32px;" row-index="0" aria-rowindex="3" class="ag-row-even ag-row-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-first ag-after-created" role="row" row-id="0"></div><div comp-id="7671" style="transform: translateY(32px); height: 32px;" row-index="1" aria-rowindex="4" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="1"></div><div comp-id="7677" style="transform: translateY(64px); height: 32px;" row-index="2" aria-rowindex="5" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="2"></div><div comp-id="7683" style="transform: translateY(96px); height: 32px;" row-index="3" aria-rowindex="6" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="3"></div><div comp-id="7689" style="transform: translateY(128px); height: 32px;" row-index="4" aria-rowindex="7" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="4"></div><div comp-id="7695" style="transform: translateY(160px); height: 32px;" row-index="5" aria-rowindex="8" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="5"></div><div comp-id="7701" style="transform: translateY(192px); height: 32px;" row-index="6" aria-rowindex="9" class="ag-row-even ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="6"></div><div comp-id="7707" style="transform: translateY(224px); height: 32px;" row-index="7" aria-rowindex="10" class="ag-row-odd ag-row-no-focus ag-row ag-row-level-0 ag-row-position-absolute ag-row-last ag-after-created" aria-label="Press SPACE to select this row." role="row" row-id="7"></div></div>
            <!--AG-ROW-CONTAINER--><div class="ag-full-width-container" ref="fullWidthContainer" role="presentation" unselectable="on" name="fullWidth" style="height: 256px;"></div>
        </div>
        <div class="ag-floating-bottom" ref="eBottom" role="presentation" unselectable="on" style="min-height: 0px; height: 0px; display: none; overflow-y: scroll;">
            ...
            <!--AG-ROW-CONTAINER--><div class="ag-floating-bottom-viewport" ref="bottomCenterContainer" role="presentation" unselectable="on" name="bottomCenter">
                <div class="ag-floating-bottom-container" ref="eContainer" role="presentation" unselectable="on" style="width: 621px; transform: translateX(0px);"></div>
            </div>
        ...
        <!--AG-FAKE-HORIZONTAL-SCROLL--><div class="ag-body-horizontal-scroll" aria-hidden="true" style="height: 0px; max-height: 0px; min-height: 0px;">
            ...
            <div class="ag-body-horizontal-scroll-viewport" ref="eViewport" style="height: 0px; max-height: 0px; min-height: 0px;">
                <div class="ag-body-horizontal-scroll-container" ref="eContainer" style="height: 0px; max-height: 0px; min-height: 0px; width: 621px;"></div>
            </div>
